...
[Открыть публичный Storybook](https://dariaeremina89-oss.github.io/design-system/)
...
Полные описания, API, ограничения, состояния и примеры находятся в разделе **Docs** у соответствующего компонента в Storybook.
