...
const preview: Preview = {
  parameters: {
    layout: 'centered',
    options: {
      storySort: { order: ["General",["Overview","Variables",["Colors",["Background colors","Border colors","Color primitives","Icon colors","Text colors"],"Shadows","Sizes"],"Typography","Icons","Layers","Custom Branding","Changelog"],"Components",["Actions",["Button","ButtonFAB","ButtonIcon","ButtonLink","ButtonToggle","Link"],"Inputs",["CodeInput","Input","MultipleFileInput","PhoneInput","PriceInput","Search","SingleFileInput","Textarea"],"Selection",["AsyncAutocomplete","Autocomplete","Checkbox","CheckboxGroup","Chips","ChipsGroup","Dropdown","ItemRow","Menu","Multiselect","Radio","RadioGroup","Select","Switch","SwitchGroup"],"Navigation",["Accordion","AccordionGroup","Breadcrumbs","Carousel","Pagination","Tabs"],"DateTime",["Calendar","DatePicker","RangeCalendar"],"Overlays",["BottomSheet","Dialog","Tooltip"],"Indicators",["Badge","CircularProgress","LinearProgress"],"Elements",["Divider","FileRow","Highlight","Icon","InfoBlock","Skeleton","Snackbar"]]], },
    },
    controls: {
      expanded: true,
    },
