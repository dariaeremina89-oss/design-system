...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Это тестовая дизайн-система и личный плейбук Дарьи для проверки токенов, компонентов и подходов к реализации F.Doc в React и Storybook. Это не официальная библиотека F.Doc и не production-пакет.',
      },
    },
  },
  tags: ['autodocs'],
