...
export const SkeletonSizes:Story={...Sizes,name:"Skeleton по размерам",args:{state:"skeleton"}};
export const SkeletonInParagraph:Story={...InParagraph,name:"Skeleton внутри абзаца",args:{...InParagraph.args,state:"skeleton"}};
