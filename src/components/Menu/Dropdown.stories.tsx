...
export const HoverAction:Story={parameters:{docs:{description:{story:'На десктопе наведение раскрывает дополнительные действия, клик выполняет Скачать PDF. На ширине до 767 px и при касании тап раскрывает меню с Скачать PDF первым пунктом. ArrowDown / ArrowUp открывают меню с клавиатуры.'}}},render:args=><HoverActionExample {...args}/>};
export const HoverActionDisabled:Story={render:args=><HoverActionExample {...args} disabled/>};
