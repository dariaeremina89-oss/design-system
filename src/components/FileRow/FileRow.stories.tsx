...
const meta = {
  ...
  component: FileRow,
  tags: ['autodocs', 'ready'],
  args: { type: 'uploaded', fileName: 'File name.png', weight: '2,7 МБ', error: false, errorText: 'Ошибка в файле', draggable: false, deletable: true },
  argTypes: { type: { control: 'select', options: ['loading', 'uploaded', 'uploaded-preview', 'disabled', 'template', 'template-edit', 'skeleton'] } },
